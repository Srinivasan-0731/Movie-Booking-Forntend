...
const SignupPage = () => {
  ...
  const handleSignup = async (e) => {
    ...
    let formattedPhone = phone ? phone.slice(-10) : "";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-pink-500 via-red-400 to-orange-400">
      <div className="w-[340px] bg-white rounded-[40px] p-6 shadow-xl relative overflow-hidden">
        ...
        <form onSubmit={handleSignup} className="relative z-10 mt-16">
          ...
          <div className="relative mb-3">
            ...
            />
            <span
              className="absolute right-4 top-2 cursor-pointer text-sm text-gray-600 font-medium"
